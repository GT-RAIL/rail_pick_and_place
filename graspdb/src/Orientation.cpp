 ...
 *
 * An orientation simply contains x, y, z, and w values. This class is useful for internal data management within the
 * graspdb  library. Convenience functions are added for use with ROS messages.
 *
